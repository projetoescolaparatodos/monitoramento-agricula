      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <Link href="/agriculture">
          <div className="relative bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-all cursor-pointer group">
            <div className="absolute -top-3 -right-3 w-12 h-12 bg-primary rounded-full transform group-hover:scale-110 transition-transform"></div>
        ...
        <Link href="/fishing">
          <div className="relative bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-all cursor-pointer group">
            <div className="absolute -top-4 -right-4 w-16 h-16 bg-primary rounded-full transform group-hover:scale-110 transition-transform"></div>
            <div className="absolute -top-5 -right-5 w-16 h-16 flex items-center justify-center">
