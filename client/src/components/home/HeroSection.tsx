...
const HeroSection = () => {
  ...
  return (
    <section className="mb-16 h-[400px]"> {/* Reduced height */}
      <div className="bg-green-700 rounded-lg overflow-hidden shadow-lg relative"> {/* Added relative for positioning */}
        <div className="md:flex">
          <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center relative"> {/* Added relative for positioning */}
            <div className="absolute inset-0 flex items-center justify-center opacity-10"> {/* Added icon container */}
              <img src="/logo.png" alt="Logo" className="w-auto h-1/2" /> {/* Assumed /logo.png exists; adjust path as needed */}
            </div>
            <div className="relative z-10"> {/* Ensures text is on top */}
              {isLoading ? (
