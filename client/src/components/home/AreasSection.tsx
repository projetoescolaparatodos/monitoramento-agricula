...
export const AreasSection = () => {
  ...
  return (
    <section className="py-16 bg-gradient-to-b from-gray-50 to-white" id="areas">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl font-bold text-center mb-12 text-gray-800 tracking-tight font-sans">
          Áreas de Atuação
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            <Link href="/agriculture" onClick={() => setTimeout(() => window.scrollTo(0, 0), 100)}>
              <div
                className="group relative bg-white rounded-2xl shadow-md p-8 cursor-pointer hover:shadow-xl transition-all duration-500 transform hover:-translate-y-1 border border-gray-100 hover:border-green-300 overflow-hidden"
                role="link"
                aria-label="Explorar Agricultura"
              >
                {/* Subtle background overlay on hover */}
                <div className="absolute inset-0 bg-gradient-to-br from-green-50 to-transparent opacity-0 group-hover:opacity-20 transition-opacity duration-500" />
          ...
          >
            <Link href="/fishing" onClick={() => setTimeout(() => window.scrollTo(0, 0), 100)}>
              <div
                className="group relative bg-white rounded-2xl shadow-md p-8 cursor-pointer hover:shadow-xl transition-all duration-500 transform hover:-translate-y-1 border border-gray-100 hover:border-blue-300 overflow-hidden"
                role="link"
                aria-label="Explorar Pesca"
              >
                <div className="absolute inset-0 bg-gradient-to-br from-blue-50 to-transparent opacity-0 group-hover:opacity-20 transition-opacity duration-500" />
          ...
          >
            <Link href="/paa" onClick={() => setTimeout(() => window.scrollTo(0, 0), 100)}>
              <div
                className="group relative bg-white rounded-2xl shadow-md p-8 cursor-pointer hover:shadow-xl transition-all duration-500 transform hover:-translate-y-1 border border-gray-100 hover:border-orange-300 overflow-hidden"
                role="link"
                aria-label="Explorar PAA"
              >
                <div className="absolute inset-0 bg-gradient-to-br from-orange-50 to-transparent opacity-0 group-hover:opacity-20 transition-opacity duration-500" />
