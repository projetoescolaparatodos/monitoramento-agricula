...
const MediaGallerySection: React.FC<MediaGallerySectionProps> = ({ mediaItems, isLoading }) => {
  return (
    <section id="media" className="py-12 bg-neutral-50 dark:bg-zinc-900 rounded-2xl">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold mb-4 text-center text-gray-800 dark:text-white">Galeria de Mídia</h2>
